...
public class formrumahsakit extends javax.swing.JFrame {
    ...
    private void TampilData (){
     ...
     private void TambahData(String nama1, String tl1, String usia1, String jk, String diagnosa1, String dokter1, String ruangan1, String tanggal1){
        try{
            String sql = "INSERT INTO rumahsakit VALUES (NULL,'"+nama1+"','"+tl1+"','"+usia1+"','"+jk+"','"+diagnosa1+"','"+dokter1+"','"+ruangan1+"','"+tanggal1+"')";
            stt = con.createStatement();
